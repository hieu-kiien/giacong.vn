...
export const DEMO_CATALOG_PRODUCTS: readonly CatalogProductDetail[] = [
  ...
  // Pagination fixtures: extra demo rows keep search, sorting and dense grids useful
  // while the approved product feed and photography are still pending.
  product({
    categorySlug: "bot-nguyen-lieu-kho",
    description:
      "Bột yến mạch hòa tan dùng cho thức uống dinh dưỡng, ngũ cốc và sản phẩm pha sẵn.",
    id: 71_010,
    name: "Bột yến mạch hòa tan",
    shortDescription: "Bột yến mạch hòa tan, hai quy cách bao.",
    slug: "bot-yen-mach-hoa-tan",
    variants: [
      {
        contactFrom: 240,
        id: 71_101,
        ...
        optionId: 5_191,
        optionLabel: "Bao 10 kg",
        sku: `${DEMO_SKU_PREFIX}-BYM-10`,
        step: 6,
        tiers: [[12, 264_000], [60, 252_000], [180, 240_000]],
        unit: "bao",
      },
      {
        contactFrom: 150,
        ...
        optionId: 5_192,
        optionLabel: "Bao 20 kg",
        sku: `${DEMO_SKU_PREFIX}-BYM-20`,
        step: 3,
        tiers: [[6, 498_000], [30, 476_000], [90, 452_000]],
        unit: "bao",
      },
    ],
  }),
  product({
    categorySlug: "tra-thao-moc-say",
    description:
      "Gừng lát sấy khô dùng cho trà thảo mộc, bột pha uống và sản phẩm ngâm chiết.",
    id: 71_011,
    name: "Trà gừng lát sấy",
    shortDescription: "Gừng lát sấy, quy cách thùng tiêu chuẩn.",
    slug: "tra-gung-lat-say",
    variants: [{
      contactFrom: 100,
      id: 71_111,
      moq: 4,
      optionId: 5_201,
      optionLabel: "Thùng 4 kg",
      sku: `${DEMO_SKU_PREFIX}-TGL-04`,
      step: 2,
      tiers: [[4, 382_000], [20, 367_000], [60, 349_000]],
      unit: "thùng",
    }],
  }),
  product({
    categorySlug: "tra-thao-moc-say",
    description:
      "Đài hoa hibiscus sấy giữ màu tự nhiên, dùng cho trà túi lọc và đồ uống pha chế.",
    id: 71_012,
    name: "Đài hoa hibiscus sấy",
    shortDescription: "Hibiscus sấy, hai quy cách thùng.",
    slug: "dai-hoa-hibiscus-say",
    variants: [
      {
        contactFrom: 75,
        id: 71_121,
        ...
        optionId: 5_211,
        optionLabel: "Thùng 3 kg",
        sku: `${DEMO_SKU_PREFIX}-HBS-03`,
        step: 1,
        tiers: [[3, 468_000], [15, 449_000], [45, 427_000]],
        unit: "thùng",
      },
      {
        contactFrom: 50,
        ...
        moq: 2,
        optionId: 5_212,
        optionLabel: "Thùng 6 kg",
        sku: `${DEMO_SKU_PREFIX}-HBS-06`,
        step: 1,
        tiers: [[2, 895_000], [10, 859_000], [30, 816_000]],
        unit: "thùng",
      },
    ],
  }),
  product({
    categorySlug: "sot-gia-vi-long",
    description:
      "Sốt ớt lên men theo mẻ, dùng cho sản phẩm ăn liền, bếp công nghiệp và đồ chấm đóng chai.",
    id: 71_013,
    name: "Sốt ớt lên men",
    shortDescription: "Sốt ớt lên men, quy cách can 5 lít.",
    slug: "sot-ot-len-men",
    variants: [{
      contactFrom: 120,
      id: 71_131,
      ...
      optionId: 5_221,
      optionLabel: "Can 5 lít",
      sku: `${DEMO_SKU_PREFIX}-SOL-05`,
      step: 6,
      tiers: [[12, 286_000], [60, 274_000], [90, 264_000]],
      unit: "can",
    }],
  }),
  product({
    categorySlug: "bao-bi-dong-goi",
    description:
      "Chai PET trong dùng cho nước uống và sản phẩm lỏng, phù hợp dây chuyền chiết rót demo.",
    id: 71_014,
    name: "Chai PET chiết rót",
    shortDescription: "Chai PET, hai dung tích minh họa.",
    slug: "chai-pet-chiet-rot",
    ...
    variants: [
      {
        ...
        optionId: 5_231,
        optionLabel: "500 ml",
        sku: `${DEMO_SKU_PREFIX}-CPT-500`,
        step: 10,
        tiers: [[20, 1_120_000], [80, 1_078_000], [160, 1_032_000]],
        unit: "thùng",
      },
      {
        contactFrom: 100,
        ...
        moq: 10,
        optionId: 5_232,
        optionLabel: "1.000 ml",
        sku: `${DEMO_SKU_PREFIX}-CPT-1000`,
        step: 5,
        tiers: [[10, 1_380_000], [40, 1_326_000], [80, 1_268_000]],
        unit: "thùng",
      },
    ],
  }),
  product({
    categorySlug: "bao-bi-dong-goi",
    description:
      "Túi giấy kraft có quai cho hộp quà, trà và sản phẩm khô, dùng để minh họa quy cách bao bì.",
    id: 71_015,
    name: "Túi giấy kraft có quai",
    shortDescription: "Túi giấy kraft, kiện 100 chiếc.",
    slug: "tui-giay-kraft-co-quai",
    variants: [{
      contactFrom: 100,
      id: 71_151,
      moq: 5,
      optionId: 5_241,
      optionLabel: "Kiện 100 chiếc",
      sku: `${DEMO_SKU_PREFIX}-TGK-100`,
      step: 5,
      tiers: [[5, 420_000], [25, 399_000], [75, 375_000]],
      unit: "kiện",
    }],
  }),
  product({
    categorySlug: "bot-nguyen-lieu-kho",
    description:
      "Bột matcha pha chế dùng cho đồ uống, bánh và sản phẩm bột hòa tan theo công thức demo.",
    id: 71_016,
    name: "Bột matcha pha chế",
    shortDescription: "Bột matcha pha chế, bao 8 kg.",
    slug: "bot-matcha-pha-che",
    variants: [{
      contactFrom: 160,
      id: 71_161,
      moq: 8,
      optionId: 5_251,
      optionLabel: "Bao 8 kg",
      sku: `${DEMO_SKU_PREFIX}-BMP-08`,
      step: 4,
      tiers: [[8, 1_180_000], [40, 1_132_000], [120, 1_076_000]],
      unit: "bao",
    }],
  }),
];
