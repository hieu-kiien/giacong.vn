...
2. **Production bắt buộc đặt secret:** thêm Script Property `CONTACT_WEBHOOK_SECRET`; đặt đúng cùng giá trị trong biến môi trường Next.js. Code vẫn hỗ trợ secret trống cho local/test theo quyết định Lean V1, nhưng không được dùng cấu hình đó ở production.
